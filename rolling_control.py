...
right1 = font.render('None', True, WHITE)
right2 = font.render('None', True, WHITE)
right3 = font.render('None', True, WHITE)
rightArr = ["none", "none", "none"]
leftHist = font_hist.render('Left History', True, WHITE)
left1 = font.render('None', True, WHITE)
left2 = font.render('None', True, WHITE)
left3 = font.render('None', True, WHITE)
...
def cw(channel):
    print ("Cw")
    if right:
        motor_pls("right" , "cw") # make the right wheel go clockwise using motor_pls with wheel "right" and command "cw"
    else:
        motor_pls("left", "cw")
...
#Run loop to display everything on the pi.
running = True
isGo = True 
...
while running:
    ...
    #render quit button upper right
